...
rounded-full bg-amber px-6 py-3 font-mono text-xs uppercase tracking-widest text-bg transition-transform hover:scale-[1.03]
    <a
      href={`mailto:${profile.email}`}
      className="
        flex h-16 w-16 items-center justify-center
        ...
        text-xs uppercase tracking-widest text-bg transition-transform hover:scale-[1.03]
      "
    >
      <Mail size={30}/>
    </a>
