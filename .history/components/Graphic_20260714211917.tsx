...
const artworkDrive = "https://drive.google.com/drive/folders/1nUy2rxaA1wuPvJ03XNBPlE4jWhHI-q1t?usp=sharing";
...
export default function GraphicsPage() {
  ...
  const filteredGraphics =
    filter === "All"
      ...
      : filter === "Artwork"
      ? graphics.filter((item) => item.category === "Artwork").slice(0, 12)
