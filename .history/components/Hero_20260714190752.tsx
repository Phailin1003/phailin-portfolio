...
const stack = ["TypeScript", "React", "Next.js", "Node.js", "PostgreSQL", "Go", "AWS"];
      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-[1.1fr_0.9fr] md:py-28">
        ...
        <div className="relative flex items-center justify-center">
          <div className="relative aspect-[4/5] w-full max-w-sm overflow-hidden rounded-3xl border border-border bg-surface">
            {/* Replace this block with an <Image src="/your-photo.jpg" /> from next/image */}
            <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-surface2 to-bg">
              <span className="font-display text-7xl italic text-border">
                {initials}
              </span>
            </div>
          </div>
