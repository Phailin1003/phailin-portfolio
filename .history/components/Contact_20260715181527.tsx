...
export default function Contact() {
        ...
        <div className="grid gap-12 md:grid-cols-[0.4fr_0.6fr] md:gap-16">
          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              ...
              {/* Location */}
              <div className="group flex items-center gap-4 rounded-xl border border-border bg-background/50 p-4 transition-all hover:border-amber hover:bg-amber/5">
            ...
            <div className="mt-8 flex gap-5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex h-12 w-12 items-center justify-center rounded-xl border border-gray-200 bg-white/80 text-gray-500 backdrop-blur-sm shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-2 hover:border-black hover:bg-black hover:text-white hover:shadow-[0_15px_35px_rgba(0,0,0,0.25)]"
              >
                <FaGithub
                  size={30}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex h-12 w-12 items-center justify-center rounded-xl border border-gray-200 bg-white/80 text-gray-500 backdrop-blur-sm shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-2 hover:border-blue-500 hover:bg-blue-500 hover:text-white hover:shadow-[0_15px_35px_rgba(59,130,246,0.35)]"
              >
                <FaFacebook
                  size={30}
                  className="transition-transform duration-300 group-hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex h-12 w-12 items-center justify-center rounded-xl border border-gray-200 bg-white/80 text-gray-500 backdrop-blur-sm shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-2 hover:border-blue-700 hover:bg-blue-700 hover:text-white hover:shadow-[0_15px_35px_rgba(29,78,216,0.35)]"
              >
                <FaLinkedin
                  size={30}
                  className="transition-transform duration-300 group-hover:scale-110"
          ...
          <form
            ...
            className="space-y-6 rounded-2xl border border-border bg-surface/60 p-6 sm:p-8 shadow-xl backdrop-blur-sm transition-all duration-300 hover:border-amber/40"
          >
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="group">
                ...
                <input
                  ...
                  className="mt-3 w-full rounded-xl border border-border bg-surface/70 px-4 py-3.5 text-sm text-text outline-none transition-all duration-300 placeholder:text-muted focus:border-amber focus:ring-2 focus:ring-amber/20"
 ...
 {/* subject */}
            ...
            <button
              ...
              className="group relative overflow-hidden rounded-full bg-amber px-8 py-3.5 font-mono text-xs uppercase tracking-[0.2em] text-bg transition-all duration-300 hover:scale-[1.04] hover:shadow-lg hover:shadow-amber/30 disabled:opacity-60 disabled:cursor-not-allowed"
            >
