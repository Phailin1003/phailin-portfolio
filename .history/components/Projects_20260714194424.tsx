...
/>
              <div>
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span
                    className={`shrink-0 rounded-full border px-3 py-1 font-mono text-[10px] uppercase tracking-widest ${statusStyles[project.status]}`}
                  >
              ...
              <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex gap-4 font-mono text-xs uppercase tracking-widest">
                  {project.repo && (
                    <a href={project.repo} className="text-blue hover:text-text">
                      Code
                    </a>
                  )}
                  {project.href && (
                    <a href={project.href} className="text-blue hover:text-text">
                      Live
                    </a>
                  )}
                </div>
