...
export const experience: ExperienceItem[] = [
  ...
  },
  {
    ...
    description:
      "Developed HongHong, a web platform for property rentals and real estate listings, with search and filtering across apartments, houses, and commercial properties. Built responsive, user-friendly interfaces with React / Next.js, optimized site performance, and created custom company profile websites for various clients.",
  },
  {
...
export const projects: Project[] = [
{
    ...
    name: "TEAMPLATE",
    description:
      "A website for a property developer company.",
