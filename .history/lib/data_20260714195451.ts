...
export const projects: Project[] = [
  ...
  description:
    "Developed a responsive WordPress website for a digital agency featuring service pages, portfolio showcase, contact forms, and SEO-friendly design for an enhanced user experience.",
